              ...
              >
                <Card className="overflow-hidden">
                  <div className={`bg-${item.bg}-subtle rounded-top py-4`}>
                    ...
                    <p className="fs-11 fw-medium badge bg-primary py-2 px-3 product-lable mb-0">
                      {item.best || ""}
                    </p>
              ...
              <Row className="gy-4">
                ...
                <Col xl={3} md={6}>
                  <div>
                    ...
                    <Form.Select
                      ...
                      onChange={(e) => handleratting(e.target)}
                    >
                ...
                <Col xl={3} md={6}>
                  <div>
                    ...
                    <Form.Select
                      aria-label="Discount"
                      onChange={(e) => handledicount(e.target)}
                    >
      ...
      <Row className="g-3">
        <Col xxl={cxxl || ""} lg={clg || ""} md={cmd || ""}>
          <div className="product-banner-1 mt-3 mt-lg-0 rounded overflow-hidden">
            ...
            <div className="product-content p-4">
              <p className="text-uppercase fw-semibold text-white mb-2">
                Up to 50-70%
              </p>
              <h1 className="text-white lh-base ff-secondary display-6 display-xl-5">
                {" "}
        ...
        <Col xxl={cxxl || ""} lg={clg || ""} md={cmd || ""}>
          <div className="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden right">
            ...
            <div className="product-content p-4 text-end">
              <p className="text-uppercase text-white fw-semibold mb-2">
                MEGA SALE
              </p>
              <h1 className="text-white lh-base ff-secondary display-6 display-xl-5">
                Running Shoes Sales Up to 50%
              </h1>
              <div className="product-btn mt-3 mt-xl-4">
                <Link to="#" className="link-effect link-light fs-14">
                  Shop Now <i className="bi bi-arrow-right ms-2"></i>
        ...
        <Col xxl={cxxl || ""} lg={clg || ""} md={cmd || ""}>
          <div className="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden">
            ...
            <div className="product-content p-4">
              <p className="text-uppercase fw-semibold text-body mb-2">
                Summer Sales
              </p>
              <h1 className="lh-base ff-secondary display-6 display-xl-5">
                Trendy Fashion Clothes
              </h1>
              <div className="product-btn mt-3 mt-xl-4">
                <Link
                  to="/products-grid/right"
                  className="link-effect link-primary fs-14"
                >
                  Shop Now <i className="bi bi-arrow-right ms-2"></i>
                </Link>
              </div>
            ...
            <div className="text-center">
              ...
              <Form action="#">
                <div className="position-relative ecommerce-subscript">
                  ...
                  <Button
                    type="submit"
                    className="btn btn-darken-primary rounded-pill"
                  >
                    Subscript Now
                  </Button>
                </div>
        ...
        <div className="svg-shape">
          ...
          >
            <g mask='url("#SvgjsMask1039")' fill="none">
              ...
              ></rect>
              <path
                d="M 0,85 C 288,68.8 1152,20.2 1440,4L1440 120L0 120z"
                fill="var(--tb-body-bg)"
              ></path>
            </g>
            <defs>
