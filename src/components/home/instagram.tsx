            ...
            {(instadata || [])?.map((item: any, key: any) => {
              const popover = (
                <Popover id="popover-basic">
                  ...
                  <Popover.Body>{item.body}</Popover.Body>
                </Popover>
              );

              return (
                <div
                  className="col-xxl-2 col-lg-3 col-md-6 d-none d-xxl-block"
                  key={key}
                >
                  <div className="position-relative">
                    ...
                    >
                      <Button
                        ...
                        variant="light"
                        size="sm"
                        className="btn-icon btn-sm rounded-circle position-absolute bottom-0 end-0 m-3"
                      >
