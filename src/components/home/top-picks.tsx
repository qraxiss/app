                        ...
                        <Col lg={7}>
                            <div className="section-content text-center mb-5">
                                <h2 className="title fw-normal">
                                    <span>Top Picks On</span> <span className="fw-semibold"> Shopcek </span>
                                </h2>
                            </div>
                        </Col>
                    </Row>
                                                ...
                                                <Card.Body className="p-2">
                                                    <div className="position-relative p-4">
                                                        ...
                                                        <ul className="product-menu list-unstyled">
                                                            <li className="mb-2">
                                                                <Link to="/#" className="rounded-circle bookmark" data-bs-toggle="button">
                                                                    <i className="bi bi-star"></i>
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link to="/product-overview" className="rounded-circle">
                                                        ...
                                                        <div className="product-btn mx-auto">
                                                            <div className="bg-body p-2">
                                                                <div className="d-flex flex-wrap justify-content-center gap-1">
                                                                    ...
                                                                    {item.colors?.slice(0, 1)?.map((color: any, idx: any) => (
                                                                        <div
                                                                            key={idx}
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-trigger="hover"
