...
const ListProductData = ({ listnoslider }: any) => {
  ...
  const currentdata = useMemo(
    () => listnoslider.slice(indexOfFirst, indexOfLast),
    [listnoslider, indexOfFirst, indexOfLast],
  );
                      ...
                      <Col className="col-md">
                        <div>
                          ...
                          <p className="text-muted mb-3">
                            ...
                            material all size available hirt fully cotton
                            material all size available.
                          </p>
