...
export const shoprry = [
  {
    ...
    img: shoprry1,
    content:
      "One or two brand names can look classy, but too many can detract from the sophistication you're going for.",
    title: "Women Fashion",
    position: "right",
  },
  {
    ...
    img: shoprry2,
    content:
      "A capsule collection is essentially a condensed version of a designer's vision",
  ...
  },
  {
    ...
    img: shoprry3,
    content:
      "Yours may consist of traditional pieces, such as tops, bottoms, and outerwear, or focus on a single product",
    title: "Men'swear",
    position: "right",
  },
  {
    ...
    img: shoprry4,
    content:
      "Typical sport-specific garments include tracksuits, shorts, T-shirts and polo shirts.",
    title: "Sportwear",
    position: "right",
  },
  {
  ...
  },
  {
    ...
    img: shoprry6,
    content:
      "Footwear refers to garments worn on the feet, which typically serves the purpose of protection against adversities.",
    title: "Footwear",
    position: "left",
  },
];
