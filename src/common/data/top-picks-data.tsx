...
const choosedata = [
  {
    id: 1,
    header: "Top-Quality Web3 Merchandise",
    info: "Access high-quality merchandise from your favorite web3 projects and influencers, each designed with precision and a passion for the blockchain community.",
    icon: "bi bi-shield-check",
  },
  {
    id: 2,
    header: "Optimized Global Shipping",
    info: "Enjoy competitive global shipping options designed to deliver your purchases quickly and affordably, no matter where you are",
    icon: "bi bi-truck",
  },
  {
    id: 3,
    header: "Secure Crypto Transactions",
    info: "Our payment platform supports a wide range of cryptocurrencies, enhanced with secure NFT-based purchase verification",
...
export { pickdata, choosedata, instadata, subarrivaldata };
