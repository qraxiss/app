            ...
            <Col lg={5}>
              <div className="text-center">
                ...
                <p className="fs-16 mb-0 text-white-75">
                  Let's start something great together. Get in touch with one of
                  the team today!
                </p>
              </div>
            </Col>
                    ...
                    <Card.Body className="p-4">
                      <div className="d-flex">
                        <div className="avatar-sm flex-shrink-0">
                          <div
                            className={`avatar-title bg-${item.color}-subtle text-${item.color} rounded fs-17`}
                          >
                  ...
                  <Row>
                    ...
                    <Col lg={12}>
                      <div className="text-end mt-4">
                        ...
                        >
                          Send Message{" "}
                          <i className="bi bi-arrow-right-short align-middle fs-16 ms-1"></i>
                        </Button>
                      </div>
                    </Col>
                  </Row>
