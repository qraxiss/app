        ...
        <Row className="gy-3">
          <Col lg={6} xs={12}>
            <div className="form-check card-radio">
              ...
              >
                <span
                  className={`${HomeAdd ? "mb-3 text-uppercase fw-semibold d-block" : "d-none"}`}
                >
                  {HomeAdd || ""}
                </span>
                <span className="fs-14 mb-2 d-block fw-semibold">
                  Witney Blessington
                </span>
          ...
          <Col lg={6} xs={12}>
            <div className="form-check card-radio">
              ...
              >
                <span
                  className={`${officeAdd ? "mb-3 text-uppercase fw-semibold d-block" : "d-none"}`}
                >
                  {officeAdd || ""}
                </span>
                <span className="fs-14 mb-2 d-block fw-semibold">
            ...
            <div className="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
              ...
              <div>
                ...
                >
                  <i
                    className="ri-delete-bin-fill text-muted align-bottom me-1"
                    onClick={RemoveModel}
                  ></i>{" "}
                  Remove
                </Link>
