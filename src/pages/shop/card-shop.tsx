      ...
      (productData || []).map((count: any) =>
        count.id === item.id && count.num > 0
          ? {
              ...
              Total: (item.num > 0 ? item.num - 1 : 0) * item.ItemPrice,
            }
          : count,
      ),
    );
      ...
      <Col lg={8}>
        <div className="d-flex align-items-center mb-4">
          <h5 className="mb-0 flex-grow-1 fw-medium">
            There are <span className="fw-bold product-count">4</span> products
            in your cart
          </h5>
                ...
                <Row className="gy-3">
                  <Col className="col-sm-auto">
                    <div className="avatar-lg h-100">
                      <div
                        className={`avatar-title bg-${item.bg}-subtle rounded py-3`}
                      >
